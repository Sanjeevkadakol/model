...
function updateAnalysisResults(data) {
    ...
    document.getElementById('vegetationValue').textContent = 
        `${Math.round(data.environmental_indicators.vegetation)}%`;
    document.getElementById('waterValue').textContent = 
        `${Math.round(data.environmental_indicators.water)}%`;
    document.getElementById('urbanValue').textContent = 
        `${Math.round(data.environmental_indicators.urban)}%`;
    document.getElementById('deforestationValue').textContent = 
        `${Math.round(data.environmental_indicators.deforestation)}%`;
    ...
    data.tags.forEach(tag => {
        ...
        tagElement.innerHTML = `
            ${tag.name}
            <span class="confidence">${Math.round(tag.confidence)}%</span>
        `;
